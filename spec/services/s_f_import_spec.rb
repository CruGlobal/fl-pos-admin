...
describe SFImport do
  ...
  xit('should save a record to salesforce') do
    job = sfi.create_job 16, '2024-12-08', '2024-12-09'
    inventory = [{"Product_Code__c":"BKP21475","Quantity__c":"9","Source_Code__c":"WTR25CHS1","Agent__c":"Lightspeed","Upsert_Key__c":"WTR25CHS1-BKP21475"}]
    sfi.push_inventory_to_sf job, inventory
    upserted = sfi.get_inventory_from_salesforce job, "WTR25CHS1"
    puts "Upserted: #{upserted.inspect}"
  end
